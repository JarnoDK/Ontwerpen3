...
public class TestDrive {
    ...
    private Scheduler pamScheduler = new Scheduler();
...
//        uitgenodigden = createAttendees(4)
        ...
        try {
        	appt = pamScheduler.createAppointment(
        			new AppointmentBuilder(),
        			LocalDateTime.of(2021, 7, 22, 12, 30),
        			LocalDateTime.of(2021, 7, 22, 12, 30).plusHours(2),
        			 "Project Demo",
        			 createAttendees(4),
        			 new Location("Hogeschool Gent, D2.014")
        			);
        ...
        try {
        	appt = pamScheduler.createAppointment(
        			new MeetingBuilder(),
        			LocalDateTime.of(2021, 3, 21, 12, 30),
        			null,
        			"OOO III",
        			 createAttendees(4),
        			 new Location("Hogeschool Gent, B3.020")
        			);
       ...
       //vervolg... (als fouten)
        ...
        //uitgenodigden = createAttendees(2)
            ...
            try {
            	appt = pamScheduler.createAppointment(
            			new MeetingBuilder(),
            			LocalDateTime.of(2021, 4, 1, 10, 00),
            			LocalDateTime.of(2021, 4, 1, 11, 30),
            			"Project II Meeting",
            			 createAttendees(2),
            			 new Location("Hogeschool Gent, B1.032")
            			);
